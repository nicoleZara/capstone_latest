...
def add_to_favorites(request, product_id):
    ...
    if existing_favorite:
        return JsonResponse({'status': 'error', 'message': 'Product is already in your favorites'})
    ...
    return JsonResponse({'status': 'success', 'message': 'Product added to favorites successfully'})
